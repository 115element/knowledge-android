package com.example.knowledge_android.pos.printer;
...
public class PrinterFunctions {
    ...
    public static native int PrintTextKanji(String portName, int portSettings, int underline, int invertColor, int emphasized, int upsideDown, int heightExpansion, int widthExpansion, int leftMargin, int alignment, byte[] textData);
    ...
    //--------------------------
    //public static byte[] ArabicEncode(String data) {
    //    StringBuffer ss = new StringBuffer(256);
    //
    //    char lang[] = {0x1b, 0x74, 22, 0x1b, 0x52, 0};// for arabicsoft mapping
    //    ss.append(lang);
    //
    //    int m_arwp = 42;// arabic wrapping cols, default 42
    //
    //    String text = data;//scan( data);
    //    text = Utilities.Encoding.encode(text, m_arwp);
    //    text = Utilities.ReverseString.reverseStringLeftToRight(text);
    //    ss.append(text);
    //
    //    try {
    //        return ss.toString().getBytes("CP1256");
    //    } catch (Exception ex) {
    //    }
    //    return (new String("").getBytes());//error
    //}
    //--------------------------
}
