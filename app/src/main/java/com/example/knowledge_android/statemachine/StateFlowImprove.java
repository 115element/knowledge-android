...
import com.example.knowledge_android.statemachine.mybutton.TButton;
...
public class StateFlowImprove {
    ...
    public static List<Tx> buildTx(Class... eventSources){
        List<Class> eventSourceList = Arrays.stream(eventSources).collect(Collectors.toList());
        Tx tx = new Tx(eventSourceList);
        return Lists.newArrayList(tx);
    }
