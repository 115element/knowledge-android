 ...
 *
 * DragRecyclerView
 * 使用RecyclerView结合ItemTouchHelper实现可拖拽的RecyclerView.
 *
 * 可以学习到的一些技术：
 ...
 */
public class DiySwipeRecyclerView extends RecyclerView {
    ...
    public DiySwipeRecyclerView(Context context) {
        this(context, null);
    }

    public DiySwipeRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DiySwipeRecyclerView(Context context, AttributeSet attrs, int defStyle) {
