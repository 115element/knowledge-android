package com.example.knowledge_android.comparator.http;
...
public class SSLConfigConstants {
	...
	public static String TRUSTSTORE_PASSWORD="1111111111";
	public static String P12_PASSWORD="1111111111111";
	...
	static {
		try {
			...
			P12_INPUTSTREAM = new FileInputStream(new File("ssl/luosen.p12"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	public static void main(String[] args) {
		try {
			System.out.println(ClassLoader.getSystemResource("ssl/luosen.p12").openStream());
		} catch (IOException e) {
