...
public class SVG
{
   ...
   public static class  Box implements Cloneable
   {
      ...
      {
         //Bruce/20150609/ Fix bugs
         float right = maxX();
         float bottom = maxY();
         float otherRight = other.maxX();
         float otherBottom = other.maxY();
         if (other.minX < minX) minX = other.minX;
         if (other.minY < minY) minY = other.minY;
         width = Math.max(right, otherRight) - minX;
         height = Math.max(bottom, otherBottom) - minY;
   ...
   protected static class SvgElementBase extends SvgObject
   {
      ...
      public boolean isVisible() {
          return style == null || style.visibility == null || style.visibility;
      }
   }
