package com.example.knowledge_android.secondary_list.view;
...
import com.example.knowledge_android.secondary_list.bean.ChildItem;
import com.example.knowledge_android.secondary_list.bean.ParentItem;
...
import com.example.knowledge_android.secondary_list.listener_interface.OnUIChangeListener;
...
public class ExpandableAdapter extends RecyclerView.Adapter {
    ...
    public ExpandableAdapter(List<Province> item) {
        this.provinces = item;
    }
    ...
    public int getItemCount() {
        ...
        Log.i("Adapter","getItemCount() ..."+size);
        return size;
    }
