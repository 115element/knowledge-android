package com.example.knowledge_android.image_text_combined.style1;
...
public class ImageTextActivity extends AppCompatActivity {
    ...
    private void initTextView2() {
        ...
        spannable.setSpan(span, str.length(), str.length() + "[smile]".length(), Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
...
*/
    ...
    public int dip2px(float dpValue) {
        final float scale = ImageTextActivity.this.getResources().getDisplayMetrics().density;
