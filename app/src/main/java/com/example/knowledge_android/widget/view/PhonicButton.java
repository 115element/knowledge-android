...
public class PhonicButton extends AppCompatButton implements View.OnTouchListener {
    ...
    PhonicButton(Context context) {
        super(context);
        init(null);
    }

    PhonicButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    PhonicButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    void setRadius(float radius) {
        ...
        if (radius > 0) {
            getGradientDrawable();
            shapeDrawable.setColor(getButtonColor());
