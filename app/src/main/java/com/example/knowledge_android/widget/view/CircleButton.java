...
//            hidePressedRing();
    ...
    private void showPressedRing() {
        ...
        pressedAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animationx) {
                pressedAnimator.setFloatValues(animationProgress, flipper++ % 2 == 0 ? 0f : 8f);
//                    shapeDrawable.setStroke(strokeWidth, strokeColor, ((Float)animationx.getAnimatedValue()), 10f)
            }
        });
        pressedAnimator.setRepeatCount(999);
        pressedAnimator.start();
    }
...
//            pressedRingWidth = (int) a.getDimension(8, pressedRingWidth);
//            a.recycle();
        }
